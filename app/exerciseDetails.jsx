...
export default function ejercicioDetalle() {
  ...
  return (
    <View className="flex flex-1">
        ...
        >
            <Anticons name="closecircle" size={hp(4.5)} color="#f44f5e" />
        </TouchableOpacity>
        ...
        <ScrollView className="mx-4 space-y-2 mt-3" showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 60}}>
            ...
            >
                Equipamiento <Text className="font-bold text-neutral-800">
                    {item?.equipment}
                </Text>
            </Animated.Text>
            ...
            <Animated.Text
                ...
                className=" text-neutral-700 tracking-wide"
            >
                Objetivo <Text className="font-bold text-neutral-800">
                    {item?.target}
                </Text>
            </Animated.Text>
